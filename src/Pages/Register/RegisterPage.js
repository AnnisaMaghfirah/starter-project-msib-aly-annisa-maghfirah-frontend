...
const RegisterPage = () => {
    const maintenanceButton = (e) => {
        e.preventDefault();
        swal("Oops!", "Website sedang dalam pengembangan!");
    }
  return (
    <>
        <div className='flex justify-center items-center h-screen w-full bg-[#008DDA]'  style={{ fontFamily: "Poppins" }}>
          {/* Form */}
          <div className='flex w-[300px] justify-center items-center flex-col h-[470px] sm:w-[420px] bg-[#fff]'>
            ...
            <div className='flex w-[240px] flex-col justify-center items-center sm:w-[330px] h-[440px]'>
              ...
              <div className="flex flex-col mt-4 w-full">
                ...
                <input type="text" name="username" className="mt-1 p-2 w-full rounded-lg text-black border-solid border-2 border-gray-400" placeholder="masukkan username anda" />
              </div>
              {/* Email */}
              <div className="flex flex-col mt-4 w-full">
                <div className="text-start text-sm font-bold">Email</div>
                <input type="email" name="email" className="mt-1 p-2 w-full rounded-lg text-black border-solid border-2 border-gray-400" placeholder="masukkan email anda" />
              </div>
              {/* Password */}
              <div className="flex flex-col mt-4 w-full">
                <div className="text-start text-sm font-bold">Password</div>
                <input type="password" name="password" className="mt-1 p-2 w-full rounded-lg text-black border-solid border-2 border-gray-400" placeholder="masukkan password anda" />
              </div>
              {/* Button */}
